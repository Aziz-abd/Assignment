...
function Logo(params) {
  return (
    <svg
      ...
      viewBox="0 7 102 20.9"
      overflow="visible"
      class="_444286386f _08314b986f a50c52d86f"
      style={{ height: "22px" }}
    >
      <defs>
        <radialGradient id="grad" cx="50%" cy="70%" r="50%">
          <stop offset="50%" stop-color={"rgb(123,105,255)"} />
      ...
      ></path>
      <circle cx="15" cy="15" r="14" fill="url(#grad)"></circle>
    </svg>
  );
}
